...
export class Repository extends React.Component {
  ...
  componentDidMount() {
      this.props.dispatch(
          actions.fetchDescription(this.props.repository.owner, this.props.repository.name)
      );
  ...
  render() {
    return (
        <div className="repository">
            {this.props.repository.owner} - {this.props.repository.name} - {this.props.repository.description}
            &nbsp;
